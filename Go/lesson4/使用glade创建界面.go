/*
 * @Author: Thinkpaddong
 * @Date: 2021-09-28 23:33:03
 * @LastEditTime: 2021-09-28 23:50:42
 * @Description:
 * @FilePath: /Test-for-github/Go/lesson4/使用glade创建界面.go
 */
package main
...
func main() {
	...
	//将图片加载到内存中
	pixbuf, _ := gdkpixbuf.NewPixbufFromFileAtScale("cls.jpg", imgw, imgh, false)
